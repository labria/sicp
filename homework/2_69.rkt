...
(define sample-pair '(('A 5) ('B 4) ('C 6)))
...
(define (successive-merge l)
  (if (null? (cdr l)) l
      (insert-in-place (make-code-tree (car l) (cadr l)) (cddr l))
  )
)
...
(encode '('A 'B 'B) (generate-huffman-tree sample-pair))
(encode '('B) (generate-huffman-tree sample-pair))
(encode '('C) (generate-huffman-tree sample-pair))
